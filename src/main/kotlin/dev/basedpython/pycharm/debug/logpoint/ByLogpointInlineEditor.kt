...
class ByLogpointInlineEditor private constructor(
    ...
    companion object {
        ...
        private const val FIELD_HEIGHT = 24
    ...
    private fun buildPanel(): JPanel {
        ...
        // An EditorTextField with no text asks for almost no width, which is how this came out as a
        // box a few pixels across sitting next to its label. A field you are about to type an
        // expression into needs room for one.
        val editorComponent = expressionEditor.component
        editorComponent.preferredSize = Dimension(
            JBUI.scale(FIELD_WIDTH),
            maxOf(editorComponent.preferredSize.height, JBUI.scale(FIELD_HEIGHT)),
        )
